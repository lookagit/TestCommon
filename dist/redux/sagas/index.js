...
var authApi_1 = __importDefault(require("../../api/authApi"));
var auth_1 = require("../reducers/auth");
var networks_1 = require("../reducers/networks");
var auth_2 = require("./auth");
var networks_2 = require("./networks");
var organizations_1 = require("../reducers/organizations");
var organizations_2 = require("./organizations");
var api = api_1.default.create('https://directory.global.smart.network/directory/dash_user_by_email');
var auth0Api = authApi_1.default.create('https://c-dev.auth0.com');
function root() {
