...
export declare const enum UserInfoTypesNames {
...
export interface SetInfoParamType extends Action<UserInfoTypesNames.USER_INFO_REQUEST | UserInfoTypesNames.USER_INFO_SUCCESS | UserInfoTypesNames.USER_INFO_FAILURE> {
    data: {
        sub: string;
        nickname: string;
        name: string;
