...
declare enum UserSettingsTypesNames {
...
export interface SetUserSettingsParamType extends Action<UserSettingsTypesNames.USER_SETTINGS_REQUEST | UserSettingsTypesNames.USER_SETTINGS_SUCCESS | UserSettingsTypesNames.USER_SETTINGS_FAILURE> {
    data: {
