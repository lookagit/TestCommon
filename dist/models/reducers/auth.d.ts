...
export declare const enum AuthTypesNames {
...
export interface SetAuthParamType extends Action<AuthTypesNames.LOGIN_REQUEST | AuthTypesNames.LOGIN_SUCCESS | AuthTypesNames.LOGIN_FAILURE | AuthTypesNames.LOGIN_LOAD | AuthTypesNames.LOGOUT_REQUEST | AuthTypesNames.LOGOUT_SUCCESS | AuthTypesNames.LOGIN_LOAD_SUCCESS | AuthTypesNames.REFRESH_REQUEST | AuthTypesNames.REFRESH_SUCCESS | AuthTypesNames.REFRESH_FAILURE | AuthTypesNames.LOGIN_FAILURE_FIELD | AuthTypesNames.INIT_STORAGE_REQUEST | AuthTypesNames.INIT_STORAGE | AuthTypesNames.INIT_STORAGE_FAILURE> {
    data: {
        access_token: string;
        expires_in: number;
        id_token: string;
