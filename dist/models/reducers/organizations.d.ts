...
export declare const enum OrganizationTypesNames {
...
export interface SetOrganizationParamType extends Action<OrganizationTypesNames.ORGANIZATIONS_REQUEST | OrganizationTypesNames.ORGANIZATIONS_SUCCESS | OrganizationTypesNames.ORGANIZATIONS_FAILURE | OrganizationTypesNames.SET_ORGANIZATIONS_REQUEST | OrganizationTypesNames.SET_ORGANIZATIONS_SUCCESS | OrganizationTypesNames.SET_ORGANIZATIONS_FAILURE> {
    data: [IOrganizations];
