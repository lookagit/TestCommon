...
export const enum NetworksTypesNames {
...
export interface NetworksParamTypes extends Action<
NetworksTypesNames.NETWORKS_REQUEST |
NetworksTypesNames.NETWORKS_SUCCESS |
NetworksTypesNames.NETWORKS_FAILURE
> {
  data: [INetworks],
  networks: [INetworks],
  error: object | null,
